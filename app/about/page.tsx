...
export const metadata = {
  ...
  description: 'Mr Meat & Co — an Alexandria, Sydney craft butcher since 2018. 100% Australian grass-fed beef, whole-carcass butchery, cold-chain across NSW and nationwide.',
  alternates: {

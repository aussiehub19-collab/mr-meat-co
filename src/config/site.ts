...
export const PAGE_SEO: Record<string, PageSeo> = {
  ...
  "/live-poultry/": {
    ...
    faqs: [
      ...
      { question: "How do I collect live birds — do you deliver?", answer: "Live poultry is collected from our farm partner by appointment, or delivered within a limited radius of Sydney for a fee. It's separate from our $300 cold-chain meat delivery. We'll confirm options when you order." },

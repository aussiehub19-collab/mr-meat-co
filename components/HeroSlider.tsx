...
const HERO_SLIDES = [
  ...
  },
  {
    ...
    description: "Hand-selected by master butchers in Alexandria. Vacuum sealed for peak freshness and tenderness. Free cold-chain delivery across NSW on orders $300+; frozen courier Australia-wide.",

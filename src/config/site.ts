...
export const PAGE_SEO: Record<string, PageSeo> = {
  ...
  "/chicken/": {
    ...
    supportingKeywords: ["free range chicken delivery", "buy chicken breast australia", "wholesale chicken", "chicken thigh fillets", "chicken mince"],
  ...
  "/ready-to-cook/": {
    ...
    supportingKeywords: ["crumbed chicken", "beef schnitzel", "gluten free schnitzel", "marinated chicken", "ready to cook meat"],
  ...
  "/specialty-meat/": {
    ...
    supportingKeywords: ["game meat near me", "kangaroo meat", "venison", "rabbit meat", "goat meat", "exotic meat australia"],
